...
export default function FloatingFilter() {
  ...
  return (
    <div className="fixed right-6 top-1/2 -translate-y-1/2 z-50 hidden lg:flex">
      <div className="flex flex-col items-stretch bg-surface/70 backdrop-blur-xl border border-outline-variant/40 shadow-[0_8px_32px_rgba(0,0,0,0.15)] rounded-[28px] w-[180px] py-5 px-3">
